...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.radioBtn_group_key_name.setGeometry(QtCore.QRect(0, 0, 61, 19))
        ...
        self.radioBtn_group_key_path.setGeometry(QtCore.QRect(100, 0, 61, 19))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.actSelectDisabled = QtWidgets.QAction(MainWindow)
        self.actSelectDisabled.setObjectName("actSelectDisabled")
        ...
        self.mnuAudioSource.addAction(self.actWwiseSilenceAdd)
        self.mnuAudioSource.addAction(self.actWwiseSilenceRemove)
        ...
        self.mnuCommon.addAction(self.actSelectDisabled)
        ...
        self.mnuCommon.addSeparator()
        self.mnuCommon.addAction(self.actImportFromFile)
        self.mnuCommon.addAction(self.actExportToFile)
        self.mnuCommon.addSeparator()
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "WaapiTools - MoreFunAudioTeam"))
        ...
        self.btnClearObjects.setText(_translate("MainWindow", "Clear Table"))
        self.radioBtn_group_key_name.setText(_translate("MainWindow", "Name"))
        self.radioBtn_group_key_path.setText(_translate("MainWindow", "Path"))
        self.radioBtn_group_ope_include.setText(_translate("MainWindow", "Include"))
        self.radioBtn_group_ope_exclude.setText(_translate("MainWindow", "Exclude"))
        self.cbxCaseSensitive.setText(_translate("MainWindow", "Case Sensitive"))
        self.cbxMatchWholeWord.setText(_translate("MainWindow", "Match Whole Word"))
        self.cbxUseRegularExpression.setText(_translate("MainWindow", "Use Regular Expression"))
        ...
        self.mnuSetInclusionTo.setTitle(_translate("MainWindow", "Set Inclusion to"))
        ...
        self.actCalculateBankSize.setText(_translate("MainWindow", "Calculate Total Media Size"))
        self.actCreateOrAddToBank.setText(_translate("MainWindow", "Create or Add to Bank Per Object"))
        ...
        self.actMoveListToSelection.setText(_translate("MainWindow", "Move List to Selection"))
        ...
        self.actBankAssignmentMatrix.setText(_translate("MainWindow", "Open Assignment Matrix"))
        self.actAddToSelectedBank.setText(_translate("MainWindow", "Add to Selected Bank"))
        self.actRenameOriginalToWwise.setText(_translate("MainWindow", "Rename Original to Wwise"))
        self.actDeleteUnusedAKDFiles.setText(_translate("MainWindow", "Delete Unused AKD files"))
        self.actClearInclusions.setText(_translate("MainWindow", "Clear Inclusions"))
        self.actBreakContainer.setText(_translate("MainWindow", "Break Container"))
        ...
        self.actIncludeMediaOnly.setText(_translate("MainWindow", "Media Only"))
        self.actIncludeEventsAndStructures.setText(_translate("MainWindow", "Events & Structures"))
        self.actIncludeAll.setText(_translate("MainWindow", "All"))
        self.actApplyFaderEditsDownstream.setText(_translate("MainWindow", "Apply Fader Edits Downstream"))
        self.actSplitByNetRole.setText(_translate("MainWindow", "Split by Net Role"))
        self.actSelectDisabled.setText(_translate("MainWindow", "Select Disabled"))
        self.actImportFromFile.setText(_translate("MainWindow", "Import from File"))
        self.actExportToFile.setText(_translate("MainWindow", "Export to File"))
        self.actCopySelectionToList.setText(_translate("MainWindow", "Copy Selection to List"))
        self.actWwiseSilenceAdd.setText(_translate("MainWindow", "Wwise Silence Add"))
        self.actWwiseSilenceRemove.setText(_translate("MainWindow", "Wwise Silence Remove"))
        self.actReplaceEventNames.setText(_translate("MainWindow", "Replace Event Names"))
        self.actBatchReplaceTool.setText(_translate("MainWindow", "Batch Replace Tool"))
